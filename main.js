	...
	// Background.
		(function() {
			...
			new slideshowBackground('bg', {
				...
				images: [
					{
						src: 'assets/images/bg-b167a368.png',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/bg-02a7d498.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
	...
	// Slideshow: slideshow01.
		(function() {
			...
			new slideshowBackground('#slideshow01', {
				...
				images: [
					{
						src: 'assets/images/slideshow01-6310f24b.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-19312638.png',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
